...
const productData: Record<string, any> = {
  networks: {
    title: "Fixline Networks",
    description: "Office Wi-Fi, secure routing, and reliable connectivity engineered for modern workspaces.",
    Icon: Network,
    accent: "brand-blue"
  },
  builds: {
    title: "Fixline Builds",
    description: "Custom computers designed specifically for performance, stability, and long-term reliability.",
    Icon: DesktopTower,
    accent: "indigo-500"
  },
  os: {
    title: "Fixline OS",
    description: "It's basically an AI mechanic for your PC. It quietly watches everything in the background—new downloads, weird processes, temp files, and network activity.",
    Icon: TerminalWindow,
    accent: "emerald-500",
    launchType: "platform"
  },
  tools: {
    title: "Fixline Tools",
    description: "A catalog of verified, high-grade hardware components and tools used in our repairs and custom builds.",
    Icon: Wrench,
    accent: "amber-500",
    launchType: "catalog"
  }
    ...
    <div className="flex-1 bg-slate-50 pt-28 pb-20 relative font-sans flex flex-col">
      ...
      <div className="max-w-5xl mx-auto px-6 w-full flex-grow flex flex-col pt-10">
        ...
        >
          ...
          <div className="absolute inset-0 bg-[url('/images/noise.svg')] opacity-[0.03] rounded-3xl pointer-events-none"></div>
          ...
          <div className="relative backdrop-blur-2xl bg-white/40 border border-white/60 shadow-[0_8px_32px_0_rgba(0,68,255,0.05)] rounded-3xl p-10 md:p-16 lg:p-24 text-center overflow-hidden m-4 md:m-8">
            ...
            <img src="/images/fixline-motif.svg" alt="" className="absolute -top-10 -right-10 w-96 h-96 opacity-[0.03] pointer-events-none" />
            ...
            <div className="relative z-10 max-w-xl mx-auto">
              ...
              <p className="text-lg text-slate-600 mb-12 font-light leading-relaxed">
                We're working hard to put the finishing touches on {product.title}. Comprehensive details, specs, and features will be available here soon.
              </p>
